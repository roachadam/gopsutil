...
[![Test](https://github.com/roachadam/gopsutil/actions/workflows/test.yml/badge.svg)](https://github.com/roachadam/gopsutil/actions/workflows/test.yml) [![Coverage Status](https://coveralls.io/repos/github/shirou/gopsutil/badge.svg?branch=master)](https://coveralls.io/github/shirou/gopsutil?branch=master) [![Go Reference](https://pkg.go.dev/badge/github.com/roachadam/gopsutil/v3.svg)](https://pkg.go.dev/github.com/roachadam/gopsutil/v3) [![Go Documentation](https://godocs.io/github.com/roachadam/gopsutil/v3?status.svg)](https://godocs.io/github.com/roachadam/gopsutil/v3) [![Calendar Versioning](https://img.shields.io/badge/calver-vMAJOR.YY.MM-22bfda.svg)](https://calver.org/)
...
import (
    ...
    "github.com/roachadam/gopsutil/v3/mem"
    // "github.com/roachadam/gopsutil/mem"  // to use v2
)
...
As of v3.23.6, it is now possible to pass a path location using `context`: import `"github.com/roachadam/gopsutil/v3/common"` and pass a context with `common.EnvMap` set to `common.EnvKey`, and the location will be used within each function.
...
See https://pkg.go.dev/github.com/roachadam/gopsutil/v3 or https://godocs.io/github.com/roachadam/gopsutil/v3
