...
# usage: cd ${GOPATH}/src/github.com/roachadam/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/roachadam/gopsutil/|"github.com/roachadam/gopsutil/v3/|g' @
